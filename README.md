...
<div>
  ...
  <ul>
    <li> 👨‍🎓 Студент 3 курса КНИТУ-КАИ им А.Н.Туполева</li>
    <li> 🔭 Являюсь студентом Школы 21</li>
    <li> 📖 В свободное время читаю книги и играю в шахматы</li>
    <li> 💻 Активно участвую в хакатонах и олимпиадах</li>
  </ul>
</div>
...
<div>
    ...
    <img src="https://github.com/tandpfun/skill-icons/blob/main/icons/Vite-Dark.svg"  width="50" height="50"/>&nbsp
    <img src="https://github.com/tandpfun/skill-icons/blob/main/icons/Vitest-Dark.svg"  width="50" height="50"/>&nbsp
...
<div>
  ...
  <ul>
    ...
    <li>🥇Победитель Хакатона Промт-инжиниринг</li>
    <li>🏆Занял 4 место в Татар.Бу хакатоне, финалист</li>
    <li>🥈Призёр Хакатона ITupolev IT Challenge 2025</li>
  </ul>
</div>
